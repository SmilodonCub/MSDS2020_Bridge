...
One of the challenges in working with data s wrangling. In this assignment we will use R to perform this task.
...
```
```{r}
#displaying the mean and median of at least 2 attributes
...
#but first, I will display the headers before any changes ordered such that the entries that will be changes are listed at the top.
